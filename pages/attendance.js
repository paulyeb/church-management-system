                        ...
                        <div className="container px-4">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="border border-emerald-500 px-4 py-4 text-emerald-600 rounded-lg">Men</th>
                                    <th class="border border-emerald-500 px-4 py-4 text-emerald-600 rounded-lg">Women</th>
                                    <th class="border border-emerald-500 px-4 py-4 text-emerald-600 rounded-lg">Children</th>
                                    <th class="border border-emerald-500 px-4 py-4 text-emerald-600 rounded-lg">Visitors</th>
