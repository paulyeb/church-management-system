    ...
    return (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-70 overflow-y-auto h-full w-full">
            <div className="relative top-40 mx-auto p-5 border 2xl:w-2/5 xl:w-2/4 lg:w-2/4 md:w-3/4 sm:w-3/4  shadow-2xl rounded-2xl bg-white">
                <div>
                    <p className="text-center text-gray-500 font-light text-3xl">Record Tithe</p>
                        <hr className=" mb-5 mt-2 mx-12"/>

                    <div className="m-4 text-center">
                        <input type="date" className="border-2 rounded font-light text-xl p-4 w-full  focus:outline-none text-gray-500" />
                    </div>
                    <div className="m-4 text-center">
                        <select className="border-2 rounded font-light text-xl p-4 focus:outline-none w-full text-gray-500">
                            <option value="family" disabled selected hidden>MEMBER</option> 
                            <option value="Alfred Korankye">Alfred Korankye</option> 
                            <option value="Morgan William-Darko">Morgan William-Darko</option> 
                            <option value="Isaac Kusi">Isaac Kusi</option> 
                        </select>
                    </div>
                    <div className="m-4 text-center">
                        <input type="number" className="border-2 rounded font-light text-xl p-4 w-full  focus:outline-none text-gray-500" placeholder="AMOUNT" />
                    </div>
                    <div className="m-4 text-center">
                        <input type="text" className="border-2 rounded font-light text-xl p-4 w-full  focus:outline-none text-gray-500" placeholder="COMMENTS" />
                    </div>
