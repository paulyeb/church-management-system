    ...
    return (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-70 overflow-y-auto h-full w-full">
            <div className="relative top-40 mx-auto p-5 border 2xl:w-2/5 xl:w-2/4 lg:w-2/4 md:w-3/4 sm:w-3/4  shadow-2xl rounded-2xl bg-white">
                <div>
                    <p className="text-center text-gray-500 font-light text-3xl">Record Offering</p>
                    ...
                    <div className="m-4 text-center">
                        <select className="border-2 rounded font-light text-xl p-4 focus:outline-none w-96 text-gray-500">
                            <option value="family" disabled selected hidden>OFFERING TYPE</option> 
                            <option value="Sunday Service">Sunday Service</option> 
                            <option value="Mid-week Service">Mid-week Service</option> 
                            <option value="Annual Harverst">Annual Harverst</option> 
                        </select>
                    </div>
                    <div className="m-4 text-center">
                        <input type="number" className="border-2 rounded font-light text-xl p-4 w-96  focus:outline-none text-gray-500" placeholder="AMOUNT" />
                    </div>
                    <div className="m-4 text-center">
